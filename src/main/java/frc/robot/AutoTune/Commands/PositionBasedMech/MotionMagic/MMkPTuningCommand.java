...
public class MMkPTuningCommand {
    ...
    /**
     * Use enum states to execute and evaluate motor speeds and positions 
     * See how it follows the calculated trajectory that is generated by Motion Magic 
     * @param kPIncrement
     * @param lowTarget
     * @param highTarget
     * @param maxkP
     ...
     * @param gravityType
     * @param motorExecute
     * @param mmCruiseVTuningCommand
     * @param mmMaxAccTuningCommand
     * @param mMkATuningCommand
     * @param kSTuningCommand
     * @param kVTuningCommand
     * @param kGTuningCommandPOS
     * @return
     */
